...
import de.unioldenburg.jade.maumau.messages.PlayerListMessage;
...
public class Dealer extends Agent {
    ...
    private void initDeck() {
    	...
    	for (String suit : suits) {
    		...
    		// Z = Zehn, B = Bube, D = Dame, K = König, A = Ass
    ...
    /**
     * Punishes a player for using a invalid card. He will get the used card back and needs to take another one.
     * @author Armin Pistoor
     */
