	...
	private void createAndStartAgents() {
		...
		try {
			...
			if (startingPosition == 0) {
				...
				gPlayerLocalName = GPlayer.PLAYER_LOCAL_NAME_PREFIX+"0";
				agent.start();
			} else {
			...
			if (startingPosition == 1) {
				...
				gPlayerLocalName = GPlayer.PLAYER_LOCAL_NAME_PREFIX+"1";
				agent.start();
			} else {
				agent = container.createNewAgent(Player.PLAYER_LOCAL_NAME_PREFIX
			...
			if (startingPosition == 2) {
				...
				gPlayerLocalName = GPlayer.PLAYER_LOCAL_NAME_PREFIX+"2";
				agent.start();
			} else {
				agent = container.createNewAgent(Player.PLAYER_LOCAL_NAME_PREFIX
